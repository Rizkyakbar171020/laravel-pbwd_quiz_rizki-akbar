    ...
    <div class="container">
        ...
        <form action="{{url('/golongan')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="gol_kode" class="form-control" id="kode_golongan" placeholder="Kode Golongan">
                </div>
            </div>
            <div class="form-group row">
                <label for="namagolongan" class="col-sm-2 col-form-label">Nama Golongan</label>
                <div class="col-sm-10">
                    <input type="text" name="gol_nama" class="form-control" id="nama" placeholder="Nama Golongan">
                </div>
            </div>
             <hr>
